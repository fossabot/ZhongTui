...
//    [scrollCell.scrollImageView sd_setImageWithURL:[NSURL URLWithString:model] placeholderImage:imageNamed(@"searchBar")];
    ...
    NSAttributedString *tipStr = [[NSAttributedString alloc] initWithString:model.money attributes:@{NSForegroundColorAttributeName:ZTRGB(255, 66, 45),NSFontAttributeName:NavTitleFont}];
