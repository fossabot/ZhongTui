...
//    image.yy_center = view.yy_center;
    ...
    NSAttributedString *attr2 = [[NSAttributedString alloc] initWithString:@" 1 " attributes:@{NSFontAttributeName:sysFont(20),NSForegroundColorAttributeName:YYRGB(255, 66, 45)}];
...
//    tip.yy_centerX = view.yy_centerX;
    ...
    withdrawMoney.backgroundColor = YYRGB(253, 122, 4);
