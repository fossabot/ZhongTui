...
@implementation UIBarButtonItem (ZTExtension)
...
+ (instancetype)setNavigationBarBackGroundImgName:(NSString*)imageName target : (UIViewController *)target selector: (SEL)selector
{
    ...
    rightButton.yy_size = rightButton.imageView.image.size;
...
+ (instancetype)itemWithImage:(NSString *)image highImage:(NSString *)highImage target:(id)target action:(SEL)action
{
    ...
    button.yy_size = button.currentBackgroundImage.size;
