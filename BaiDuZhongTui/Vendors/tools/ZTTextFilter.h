...
//这时可以使用ZTTextFilterDelegate。
@protocol ZTTextFilterDelegate <NSObject>
@optional
...
@interface ZTTextFilter : NSObject<UITextFieldDelegate>
{
    id<ZTTextFilterDelegate> textFilterDelegate;
    int  MaxLen;
    BOOL AllowNum;
    BOOL AllowCH;
    BOOL AllowLetter;
...
@property (PROPERTY_WEAK, nonatomic) id<ZTTextFilterDelegate> textFilterDelegate;
...
- (void)SetFilter:(UITextField *)textField
         delegate:(id<ZTTextFilterDelegate>)delegate
           maxLen:(int)maxLen
